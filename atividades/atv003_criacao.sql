...
('Valve Corporation', 'EUA', 1996), ('Epic Games', 'EUA', 1991),
('CD Projekt Red', 'Polônia', 2002), ('Rockstar Games', 'EUA', 1998),
('Ubisoft', 'França', 1986), ('Square Enix', 'Japão', 2003),
('Electronic Arts', 'EUA', 1982), ('FromSoftware', 'Japão', 1986),
('Bethesda', 'EUA', 1986), ('Activision Blizzard', 'EUA', 2008);

-- Inserindo dados na tabela Jogo
INSERT INTO Jogo (titulo, data_lancamento, preco, id_desenvolvedora) VALUES
('Half-Life', '1998-11-19', 49.99, 1), ('Fortnite', '2017-07-25', 0.00, 2),
('Cyberpunk 2077', '2020-12-10', 199.99, 3), ('GTA V', '2013-09-17', 119.99, 4),
('Assassin’s Creed Valhalla', '2020-11-10', 149.99, 5), ('Final Fantasy XV', '2016-11-29', 159.99, 6),
('The Sims 4', '2014-09-02', 99.99, 7), ('Elden Ring', '2022-02-25', 249.99, 8),
('Skyrim', '2011-11-11', 79.99, 9), ('Call of Duty: Modern Warfare', '2019-10-25', 199.99, 10);

-- Inserindo dados na tabela Categoria
INSERT INTO Categoria (nome) VALUES
('Ação'), ('Aventura'), ('RPG'), ('Simulação'), ('FPS'), ('Battle Royale'), ('Estratégia'), ('Terror'), ('Sandbox'), ('Mundo Aberto');
...
(1, 1), (1, 5), (2, 6), (3, 3), (4, 9), (4, 10), (5, 2), (6, 3), (7, 4), (8, 1), (8, 3), (9, 9), (9, 10), (10, 1), (10, 5);
...
(1, 1, '2023-02-10'), (2, 2, '2023-03-01'), (3, 3, '2023-03-21'), (4, 4, '2023-04-23'),
(5, 5, '2023-05-31'), (6, 6, '2023-06-06'), (7, 7, '2023-07-08'), (8, 8, '2023-08-12'),
(9, 9, '2023-09-15'), (10, 10, '2023-10-19');
